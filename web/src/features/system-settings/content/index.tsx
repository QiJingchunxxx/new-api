...
const defaultContentSettings: ContentSettings = {
  ...
  'home_landing_setting.hero_badge': '',
  'home_landing_setting.hero_title': '',
  'home_landing_setting.hero_highlight': '',
  'home_landing_setting.hero_subtitle': '',
  'home_landing_setting.hero_primary_text': '',
  'home_landing_setting.hero_primary_link': '',
  'home_landing_setting.hero_secondary_text': '',
  'home_landing_setting.hero_secondary_link': '',
  'home_landing_setting.hero_trust': '',
  'home_landing_setting.stats_enabled': true,
  'home_landing_setting.stats_title': '',
  'home_landing_setting.stats_subtitle': '',
  'home_landing_setting.stats_items': '[]',
  'home_landing_setting.models_enabled': true,
  'home_landing_setting.models_title': '',
  'home_landing_setting.models_subtitle': '',
  'home_landing_setting.models_limit': 12,
  'home_landing_setting.models_groups': '',
  'home_landing_setting.faq_enabled': true,
  'home_landing_setting.faq_title': '',
  'home_landing_setting.faq_subtitle': '',
  'home_landing_setting.faq_items': '[]',
  'home_landing_setting.community_enabled': true,
  'home_landing_setting.community_title': '',
  'home_landing_setting.community_desc': '',
  'home_landing_setting.community_links': '[]',
  'home_landing_setting.community_qr_codes': '[]',
}
